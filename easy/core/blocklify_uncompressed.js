...
Blockly.JavaScript['js_literal_number'] = function(block) {
  var code = parseFloat(block.getFieldValue('NUMBER'));
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};
Blockly.JavaScript['js_literal_string'] = function(block) {
  var code = Blockly.JavaScript.quote_(block.getFieldValue('STRING'));
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};
Blockly.JavaScript['js_literal_bool'] = function(block) {
  var code = block.getFieldValue('BOOL');
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};
Blockly.JavaScript['js_null_value'] = function(block) {
  return ['null', Blockly.JavaScript.ORDER_ATOMIC];
};
Blockly.JavaScript['js_undefined_value'] = function(block) {
  return ['undefined', Blockly.JavaScript.ORDER_ATOMIC];
};
Blockly.JavaScript['js_json_object'] = function(block) {
  var elements = Blockly.JavaScript.statementToCode(block, 'ELEMENTS');
  var code = ' {' + ((elements != '')?'\n':'') +
      elements + '}';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};
Blockly.JavaScript['js_json_element'] = function(block, context) {
...
Blockly.JavaScript['js_identifier'] = function(block) {
...
//变量修改，把blocklify改成blockly
Blockly.JavaScript['js_variable_declarator'] = function(block) {
  var variable = Blockly.JavaScript.valueToCode(block, 'VAR',
      Blockly.JavaScript.ORDER_ATOMIC);
  var value = Blockly.JavaScript.valueToCode(block, 'VALUE',
      Blockly.JavaScript.ORDER_ATOMIC);
  if (value == 'undefined') {
...
Blockly.JavaScript['js_variable_declaration_unary'] = function(block) {
  var variable = Blockly.JavaScript.valueToCode(block, 'VAR',
      Blockly.JavaScript.ORDER_ATOMIC);
  var value = Blockly.JavaScript.valueToCode(block, 'VALUE',
      Blockly.JavaScript.ORDER_ATOMIC);
...
Blockly.JavaScript['js_variable_declaration'] = function(block) {
  var declarations = Blockly.JavaScript.statementToCode(block, 'DECLARATIONS');
...
Blockly.JavaScript['js_assignment_expression'] = function(block) {
  var variable = Blockly.JavaScript.valueToCode(block, 'VAR',
...
Blockly.JavaScript['js_unary_expression'] = function(block) {
  var operator = block.getFieldValue('OPERATOR');
  var argument = Blockly.JavaScript.valueToCode(block, 'ARGUMENT',
      Blockly.JavaScript.ORDER_ASSIGNMENT);
...
Blockly.JavaScript['js_update_expression_prefix'] = function(block) {
  var argument = Blockly.JavaScript.valueToCode(block, 'ARGUMENT',
      Blockly.JavaScript.ORDER_ASSIGNMENT);
  var operator = block.getFieldValue('OPERATOR');
  var OPERATORS = {
    '++': Blockly.JavaScript.ORDER_INCREMENT,
    '--': Blockly.JavaScript.ORDER_DECREMENT
  };
  var code = operator + argument;
  if (block.outputConnection) {
...
Blockly.JavaScript['js_update_expression_noprefix'] = function(block) {
  var argument = Blockly.JavaScript.valueToCode(block, 'ARGUMENT',
      Blockly.JavaScript.ORDER_ASSIGNMENT);
  var operator = block.getFieldValue('OPERATOR');
  var OPERATORS = {
...
Blockly.JavaScript['js_binary_expression'] = function(block) {
  var OPERATORS = {
    ...
    '<=': Blockly.JavaScript.ORDER_RELATIONAL,
    '===': Blockly.JavaScript.ORDER_EQUALITY,
    '&': Blockly.JavaScript.ORDER_BITWISE_AND,
    '^': Blockly.JavaScript.ORDER_BITWISE_XOR,
    '|': Blockly.JavaScript.ORDER_BITWISE_OR,
    '>>': Blockly.JavaScript.ORDER_BITWISE_SHIFT,
    '<<': Blockly.JavaScript.ORDER_BITWISE_SHIFT,
    '>>>': Blockly.JavaScript.ORDER_BITWISE_SHIFT
  };
  var operator = block.getFieldValue('OPERATOR');
...
Blockly.JavaScript['js_member_expression'] = function(block) {
  var members = [];
  for (var i = 0; i < block.memberCount; i++) {
    members[i] = Blockly.JavaScript.valueToCode(block, 'MEMBER' + i,
      Blockly.JavaScript.ORDER_ATOMIC);
  }
...
Blockly.JavaScript['js_new_expression'] = function(block) {
  var className = Blockly.JavaScript.valueToCode(block, 'CLASS',
      Blockly.JavaScript.ORDER_ATOMIC);
  var args = [];
  for (var i = 0; i < block.argumentCount; i++) {
    args[i] = Blockly.JavaScript.valueToCode(block, 'ARGUMENT' + i,
      Blockly.JavaScript.ORDER_ATOMIC);
  }
...
Blockly.JavaScript['js_function_expression'] = function(block) {
  ...
  for (var i = 0; i < block.paramCount; i++) {
    args[i] = Blockly.JavaScript.valueToCode(block, 'PARAM' + i,
      Blockly.JavaScript.ORDER_ATOMIC);
  }
  var code = name + '=' + 'function ' +  '(' + args.join(', ') + ') {\n' + branch + '}';
  if (block.outputConnection) {
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
  } else {
    return code + ';\n';
...
//匿名函数 没有修改code
Blockly.JavaScript['js_anonimous_function_expression'] = function(block) {
  var branch = Blockly.JavaScript.statementToCode(block, 'STACK');
  var args = [];
  for (var i = 0; i < block.paramCount; i++) {
    args[i] = Blockly.JavaScript.valueToCode(block, 'PARAM' + i,
...
//动作函数  确定不能以 ;\n 结尾，修改为 \n 结尾
Blockly.JavaScript['js_call_expression'] = function(block) {
  var name = Blockly.JavaScript.valueToCode(block, 'NAME',
...
Blockly.JavaScript['js_for_statement'] = function(block) {
  ...
  if (first_targetblock) {
    if (first_targetblock.type == 'js_variable_declaration' ||
      ...
      func = Blockly.JavaScript[first_targetblock.type];
      statements_first = func.call(first_targetblock, first_targetblock);
      statements_first = Blockly.JavaScript.statementToCode(block, 'FIRST');
      statements_first = statements_first.substring(2, statements_first.length - 2);
    } else {
      statements_first = Blockly.JavaScript.sequenceToCode(block, 'FIRST');
    }
  }
  var statements_do = Blockly.JavaScript.statementToCode(block, 'DO');
  var statements_step = Blockly.JavaScript.sequenceToCode(block, 'STEP');
...
Blockly.JavaScript['js_return_statement'] = function(block) {
  var code = 'return ' + Blockly.JavaScript.valueToCode(block, 'VALUE',
    Blockly.JavaScript.ORDER_NONE) + ';';
  return code + '\n';
};

Blockly.JavaScript['js_if_statement'] = function(block) {
  var n = 0;
...
Blockly.JavaScript['js_switch_statement'] = function(block) {
  var consequent;
  var discriminant = Blockly.JavaScript.valueToCode(block, 'DISCRIMINANT',
      Blockly.JavaScript.ORDER_NONE);
  var code = 'switch (' + discriminant + ') {\n';
  for (var n = 0; n < block.caseCount_; n++) {
    var test = Blockly.JavaScript.valueToCode(block, 'CASE' + n,
        Blockly.JavaScript.ORDER_NONE);
    consequent = Blockly.JavaScript.statementToCode(block, 'DO' + n);
    code += '  case ' + test + ':\n    ' + consequent;
  }
  if (block.defaultCount_) {
    consequent = Blockly.JavaScript.statementToCode(block, 'DEFAULT');
    code += '  default:\n' + consequent;
  }
  return code + '}\n';
};